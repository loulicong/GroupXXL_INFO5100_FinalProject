 ...
 * @author raunak
 */
public class CustomerAreaJPanel_ extends javax.swing.JPanel {
     ...
     */
    public CustomerAreaJPanel_(JPanel userProcessContainer, UserAccount account,CareCenterSystem system) {
        initComponents();
        ...
        for(InRequest inRequest :system.getWorkQueue().getWorkRequestList()){
    ...
    public void populateRequestTable(){
        ...
        model.setRowCount(0);
        for(InRequest s:system.getWorkQueue().getWorkRequestList()){
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ...
        InRequest inRequest =userAccount.getInRequestList().getWorkRequestList().get(selectedRow);
    ...
    private void orderJButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Hospital hospital =system.getRestaurantDirectory().getRestaurantArrayList().get(selectedRow);
        OrderJPanel s= new OrderJPanel(userProcessContainer,userAccount,system, hospital);
        CardLayout crdLyt = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add(s);
        crdLyt.next(userProcessContainer);
    }
