...
import System.Role.HospitalContactRole;
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    PregnantDirectory userDirectory;
    BabyDirectory babyDirectory;
    BabyNurseDirectory babynurseDirectory;
    CityList cityList;
    CommunityList communityList;
    GODNurseDirectory GODnurseDirectory;
    HospitalContactDirectory hospitalcontactDirectory;
    PEDocDirectory PEdocDirectory;
    PRCDirectory PRCDirectory;
    PRCContactDirectory PRCcontactDirectory;
    GODocDirectory GODocDirectory;
...
//        hospitalDirectory.createHospitalt("restaurant_1");
...
//        PregnantDirectory userDirectory =new PregnantDirectory();
...
//        InRequest inRequest =new InRequest("",userAccount_3,userAccount_2,"pending", hospitalDirectory.getRestaurantArrayList().get(0));
        ...
        this.system=new CareCenterSystem( hospitalDirectory,  userDirectory, 
             babyDirectory,  babynurseDirectory,  cityList, 
             communityList,  GODnurseDirectory,  hospitalcontactDirectory, 
             PEdocDirectory,  PRCDirectory,  PRCcontactDirectory, 
             GODocDirectory,  inRequestList,  userAccountDirectory);
//        inRequestList = new InRequestList();
//        system.setWorkQueue(inRequestList);
//        system.getRequestInList().getWorkRequestList().add((inRequest));
//        system.getRequestInList().getWorkRequestList().add(inRequest_1);
