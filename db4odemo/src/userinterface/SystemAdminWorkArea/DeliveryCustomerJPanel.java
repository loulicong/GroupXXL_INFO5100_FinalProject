...
public class DeliveryCustomerJPanel extends JPanel {
     ...
     */
    public DeliveryCustomerJPanel(JPanel userProcessContainer, CareCenterSystem business) {
        initComponents();
    ...
    public void populateTable(){
        ...
        model.setRowCount(0);
        for(Pregnant s:business.getCustomerDirectory().getCustomerArrayList()){
    ...
    private void deleteJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignJButtonActionPerformed
        ...
        Pregnant s = business.getCustomerDirectory().getCustomerArrayList().get(selectedRow);
        ...
        for(int i = 0; i<model.getRowCount(); i++) {
            for (int j = 0; j < model.getColumnCount(); j++) {
                if (j == 1) {
                    ...
                    Pregnant s = business.getCustomerDirectory().getCustomerArrayList().get(i);
                    for (UserAccount v : business.getUserAccountDirectory().getUserAccountList()) {
                        if (s.getName().equals(v.getUsername())) {
